  ...
  return (
      <Card>
        <div className={classes["home-page"]}>
            ...
            <SectionComponent id="uploader-section" heading1="Teach the bot, what" heading2="You want to learnn!" image={uploadImage} para1="Give it a youtube video" para2="" para3="Train it now" onButtonClick={props.onTeachIt} />
